		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->выходToolStripMenuItem,
					this->назадToolStripMenuItem, this->справкаToolStripMenuItem
			});
			...
			this->выходToolStripMenuItem->Size = System::Drawing::Size(137, 20);
			this->выходToolStripMenuItem->Text = L"Выход из программы";
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &RequestForm::выходToolStripMenuItem_Click);
			// 
			// назадToolStripMenuItem
			// 
			this->назадToolStripMenuItem->Name = L"назадToolStripMenuItem";
			this->назадToolStripMenuItem->Size = System::Drawing::Size(108, 20);
			this->назадToolStripMenuItem->Text = L"В главное меню";
			this->назадToolStripMenuItem->Click += gcnew System::EventHandler(this, &RequestForm::назадToolStripMenuItem_Click);
			// 
			...
			this->справкаToolStripMenuItem->Click += gcnew System::EventHandler(this, &RequestForm::справкаToolStripMenuItem_Click);
			// 
			// maskedTextBoxPrice
			// 
